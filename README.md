...
... artifacts are [released to Clojars](https://clojars.org/ginkgo). If you are using Maven, add the following repository
...
ginkgo is built from the ground up for Clojure 1.5.1 and up.


## Continuous Integration Status

[![Continuous Integration status](https://secure.travis-ci.org/clojurewerkz/ginkgo.png)](http://travis-ci.org/clojurewerkz/ginkgo)



## ... Is a ClojureWerkz Project

ginkgo is part of the [group of Clojure libraries known as ClojureWerkz](http://clojurewerkz.org), together with
